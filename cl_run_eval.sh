...
mkdir /logdirs
python run.py eval codalab_exp/$1.jsonnet --model_name checkpoint_0 --model_config_args "{dec_min_freq: 10, use_column_value: false, mask_column: -1, use_encoder_action: false, use_bert_subtask_loss: false, use_rat_subtask_loss: false, local_pretrained: '', cv_link: true}"
python extract_preds.py --inferred /logdirs/$1-step40000/$1.infer --output checkpoint_0.$1.predicted_sql.txt
python run.py eval codalab_exp/$1.jsonnet --model_name checkpoint_1 --model_config_args "{dec_min_freq: 10, use_column_value: false, mask_column: -1, use_encoder_action: false, use_bert_subtask_loss: false, use_rat_subtask_loss: false, local_pretrained: '', cv_link: false}"
